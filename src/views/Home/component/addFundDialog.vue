<template>
  <el-dialog :visible.sync="isVisible" :title="addFundDialog.title" :close-on-click-modal='false' :close-on-press-escape='false' :modal-append-to-body="false" @close="closeDialog">
    <div class="form">
...
export default {
  ...
  created () {
    if (this.addFundDialog.type === 'edit') {
      ...
      this.form.pay = Math.abs(this.dialogRow.pay);
    } else {
