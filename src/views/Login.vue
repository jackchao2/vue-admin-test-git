        ...
        <transition name="form-fade" mode="in-out">
            <section class="form_contianer">
                <div class='titleArea rflex'>
                    ...
                    <span class='title'>小超Admin<i></i></span>
                </div>
                <el-form :model="loginForm" :rules="rules" ref="loginForm" class="loginForm">
                    <el-form-item prop="username" class="login-item">
                        <span class="loginTips">
                            <icon-svg icon-class="iconuser" /></span>
                    ...
                    <el-form-item prop="password" class="login-item">
                        <span class="loginTips">
                            <icon-svg icon-class="iconLock" /></span>
                    ...
                    <el-form-item>
                        <el-button type="success" @click="submitForm('loginForm')" class="submit_btn">SIGN IN</el-button>
                    </el-form-item>
                    <div class="tiparea">
        ...
        submitForm (loginForm) {
            this.$refs[loginForm].validate((valid) => {
                if (valid) {
                    ...
                    login(userinfo).then(res => { // 调取登录方法
                        let userList = res.data.userList;
                        // console.log(userList)
                        setToken("Token", userList.token) // token存进cookie
